...
# Browser binds
bind = CTRL ALT, n, exec, firefox &
bind = CTRL SHIFT ALT, n, exec, firefox --private-window &

# Media bindings
binde = , XF86AudioRaiseVolume, exec, wpctl set-mute @DEFAULT_AUDIO_SINK@ 0
binde = , XF86AudioRaiseVolume, exec, wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%+ -l 1.2
